        ...
        <div className="mt-8 md:mt-12 lg:mt-12 xl:mt-12 w-full md:w-2xl lg:w-2xl xl:w-2xl bg-[#F1EFE3] border-[2px] border-[#C1BBA4] px-6 sm:px-10 md:px-36 lg:px-36 xl:px-36 py-8 md:py-15 lg:py-15 xl:py-15 rounded-lg">
          ...
          {submitStatus === "success" && (
            <div className="mb-6 p-3 bg-green-100 border border-green-400 text-green-700 rounded">
              Thank you! Your message has been sent successfully. We've sent a
          ...
          <form
            ...
            className="mt-6 md:mt-10 lg:mt-10 xl:mt-10"
          >
            {/* Hidden field for your notification email */}
            <input
              type="hidden"
              name="to_email"
              value="tundegabriel999@gmail.com"
            />
            ...
            <Button
              ...
              className="w-full mt-6 md:mt-8 lg:mt-8 xl:mt-8 py-3 md:py-4 lg:py-4 xl:py-4 px-4 bg-[#7A8F8C] text-white rounded-md disabled:bg-gray-400"
            >
              <Typography className="text-lg md:text-xl lg:text-xl xl:text-xl font-semibold">
